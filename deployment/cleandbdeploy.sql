...
-- PROCEDURE: userprofile.insert_user(character varying, character varying)

-- DROP PROCEDURE IF EXISTS userprofile.insert_user(character varying, character varying);

CREATE OR REPLACE PROCEDURE userprofile.insert_user(
	IN feideid character varying,
...
-- PROCEDURE: assessment.insert_answers(integer, integer, integer, character varying)

-- DROP PROCEDURE IF EXISTS assessment.insert_answers(integer, integer, integer, character varying);

CREATE OR REPLACE PROCEDURE assessment.insert_answers(
	IN assessmentid integer,
	IN questionid integer,
	IN answertypeid integer,
...
-- PROCEDURE: assessment.get(character varying)

-- DROP PROCEDURE IF EXISTS assessment.get(character varying);

CREATE OR REPLACE PROCEDURE assessment.get(
